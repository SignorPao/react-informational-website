...
const Garden = () => {
  ...
  useEffect(() => {
    document.title = "Сад и огород";
  }, []);

  return (
    <div className="flex flex-col mb-8 lg:mb-16">
      {/* page header */}
      <div className="h-[40vh] md:h-[90vh] lg:h-[40vh] xl:h-screen bg-garden bg-no-repeat bg-bottom bg-cover flex items-center justify-center pt-16 bg-dark/10 bg-blend-multiply">
