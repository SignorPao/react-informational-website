...
const Materials = () => {
  ...
  return (
    <div className="flex flex-col mb-8 lg:mb-16">
      {/* page header */}
      <div className="h-[40vh] md:h-[90vh] lg:h-[40vh] xl:h-screen bg-materials bg-no-repeat bg-bottom bg-cover flex items-center justify-center pt-16 bg-dark/10 bg-blend-multiply">
      ...
      <div className="wrapper">
        ...
        <div className="flex items-center justify-center section md:pb-0 lg:pb-8">
          <h2 className="text-dark/80 text-sm lg:text-2xl xl:text-4xl dark:text-light">
            Всё о лучших строительных материалах
          </h2>
        </div>
        ...
        <div className="flex flex-col gap-y-6 md:flex-row md:items-start md:gap-x-4 lg:gap-x-6">
          {/* articles list */}
          <ul className="flex flex-col gap-y-8 order-2 md:order-none md:flex-[65%] md:divide-y-[1px] divide-dark/20 dark:divide-light/20">
